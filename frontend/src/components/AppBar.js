...
export default function PrimarySearchAppBar({handleSearchTermInput, handleSubmitVideoSearch}) {
	...
	{/* Mobile Github icon */}
      <MenuItem onClick={() =>{open("https://github.com/callbacc/Artistify", "_blank")}}>
        <IconButton  color="inherit">
		  	<img src='https://iconmonstr.com/wp-content/g/gd/makefg.php?i=../assets/preview/2012/png/iconmonstr-github-1.png&r=255&g=255&b=255' height='32px' />
        </IconButton>
        <p>GitHub</p>
      </MenuItem>
 
    {/* Discord icon mobile onClick={handleProfileMenuOpen}*/}
      <MenuItem  onClick={() =>{open("https://discord.gg/b2gEwT8", "_blank")}}  >
        <IconButton
     	  target='_blank'
        >
          <img src='https://discord.com/assets/28174a34e77bb5e5310ced9f95cb480b.png' height='32px' />
        </IconButton>
        <p>Discord</p>
      </MenuItem>
    </Menu>
