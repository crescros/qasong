let error = {
  ...
  PASSWORD_SHORT:
    "Well looks like your password is too short. Needs to be longer then 8 characters.",
  ...
  EMAIL_LONG:
    "Your email is longer then 255 characters? Wow, that's amazing but it's not going to work.",
